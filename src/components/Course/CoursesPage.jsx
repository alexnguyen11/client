...
import { coursesData, coursesText } from "@/data/courses"; // Import Data

const CoursesPage = () => {
  const { lang } = useLanguage();
  
  // Lấy dữ liệu theo ngôn ngữ (Fallback về 'vi' nếu lỗi)
  const currentLang = lang || "vi";
  const coursesList = Object.values(coursesData[currentLang] || coursesData["vi"]);
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                  ...
                  >
                    {text.view_detail} <span>&rarr;</span>
                  </Link>
                </div>
              </div>
            </div>
